...
//   ../es6-promise
    ...
    export class Future<T> {
        ...
        static of<T>(fn: () => T, executeFnInNewThread?: boolean): Future<T>;
        static ofWith<T>(fn: () => Future<T>, executeFnInNewThread?: boolean): Future<T>;
    ...
    export class RemoteObject<T, RemoteDesc extends JsObject, LocalDesc extends JsObject> {
        ...
        constructor(descOrFunction: Union2<LocalDesc, (RemoteDesc: any) => LocalDesc>, remote?: RemoteDesc);
        cloneDesc(): LocalDesc;
    }
